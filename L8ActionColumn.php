...
class L8ActionColumn extends ActionColumn
{
    ...
    public static function viewButton(string $url, $model, $key, bool $visible = true): string
    {
        if (!$visible)
            return '';
    ...
    public static function updateButton(string $url, $model, $key, bool $visible = true): string
    {
        if (!$visible)
            return '';
    ...
    public static function deleteButton(string $url, $model, $key, bool $visible = true): string
    {
        if (!$visible)
            return '';
    ...
    public static function ajaxDeleteButton(string $url, $model, $key, bool $visible = true, array $additionalOptions = []): string
    {
        if (!$visible)
            return '';
    ...
    public static function ajaxApproveButton(string $url, $model, $key, bool $visible = true, array $additionalOptions = []): string
    {
        if (!$visible)
            return '';
        $options = [
    ...
    public static function ajaxRevokeApprovalButton(string $url, $model, $key, bool $visible = true, array $additionalOptions = []): string
    {
        if (!$visible)
            return '';
        $options = [
